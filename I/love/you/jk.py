...
{A}╔════════════════════════════════════════════════════════════════════════════════════════╗
{A}║                            {O} INSTAGRAM  {K}DARK ATTACK  {U} HIGHLIGHT                                  {A}║
{A}║                            {A} AUTHOR    {P}: {H} Infected_aofsfof                                      {A}║
{A}║                            {A} Github    {P}: {H}github.com/infected14741                          {A}║
{A}║                            {A} WHATSAPP  {P}: {H}085731739840                                    {A}║
{A}╚════════════════════════════════════════════════════════════════════════════════════════╝
""")                                                                                                         
#Licensi
___licensi___ = (f"""{H}
...
def xoshnaw():
  ...
  try:
    httpCaht = requests.get("https://github.com/infected14741/kuntulkepo/blob/main/kepo.txt").text
    if id in httpCaht:
...
def ___login___():
    ...
    if ___cookie in ['open', 'Open', 'OPEN']:
        print(f"{A}╚═➣{M} You will be directed to the creator of this program !!!");sleep(3);os.system('xdg-open https://wa.me/+6285731739840?text=Bg+Cara+Ambil+Cookies+Ig+Kek+Mana?');___login___()
    elif ___cookie in ['', ' ']:
        ...
        try:
            ...
            os.system('xdg-open https://wa.me/+6285731739840?text=MAKASIH+BANG+SUDAH+AKTIFIN+ID+GUA')
