...
{A}║                            {A} AUTHOR    {P}: {H}Infected_aofsfof / Fauzi IFC                  {A}║
{A}║                            {A} Github    {P}: {H}github.com/infected14741                      {A}║
{A}║                            {A} Instagram {P}: {H}Instagram_aofsfof                             {A}║
{A}╚════════════════════════════════════════════════════════════════════════════════════════╝
""")                                                                                                         
#Licensi
___licensi___ = (f"""{H}
...
def ___login___():
    ...
    if ___cookie in ['open', 'Open', 'OPEN']:
        print(f"{A}╚═➣{M} Apa kamu tau aku cinta indah mewanty m!!!");sleep(3);os.system('xdg-open https://wa.me/+6285846626211?text=Min+Cara+Ambil+Cookies+Ig+Kek+Mana?');___login___()
    elif ___cookie in ['', ' ']:
        ...
        try:
            ...
            os.system('xdg-open https://wa.me/+6285731739840?text=MAKASIH+ADMIN+SUDAH+AKTIFIN+ID+KU')
